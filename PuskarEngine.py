...
def main():
    ...
    for i in range(0, 3):
        ...
        su = input("Enter the suit of the card (S,D,C,H)\n")
        hand.append(Cards(va, su.lower()))
...
def check_colorrun(lis1):
    if check_run(lis1) is True and check_color(lis1) is True:
        return True
...
def check_hand(lis5):
    if check_trial(lis5) is True:
        handtype1 = "Trial"
        return handtype1
    elif check_colorrun(lis5) is True:
        handtype1 = "Colorrun"
        return handtype1
    elif check_run(lis5) is True:
        handtype1 = "Run"
        return handtype1
    elif check_color(lis5) is True:
        handtype1 = "Color"
        return handtype1
    elif check_pair(lis5) is True:
        handtype1 = "Pair"
        return handtype1
    else:
        handtype1 = "Top"
